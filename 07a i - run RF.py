...
with open('D:/Programmering/msc/Masterthesis_S23-Results/dicts/target_summaries_RF.pkl', 'wb') as fp:
    pickle.dump(target_summaries, fp)

classification_summaries = summarize_with_df(target_summaries)
with open('D:/Programmering/msc/Masterthesis_S23-Results/dicts/classification_summaries_RF.pkl', 'wb') as fp:
    pickle.dump(classification_summaries, fp)

with open('D:/Programmering/msc/Masterthesis_S23-Results/dicts/roc_information_RF.pkl', 'wb') as fp:
